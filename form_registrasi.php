    ...
    <div class="container">
        ...
        <div class="form-group row">
            ...
            <select id="program_studi" name="program_studi" class="custom-select" required="required">
                <?php foreach($program_studi as $key => $value) { ?> <!--key = si,ti,bd yg di file proses. value= isinya"sistem informasi",dll.-->
      ...
      <table class="table table-bordered">
        ...
        <?php 
        if(isset($_POST['submit'])){//sumbit dari name submit.
            $nim = $_POST['nim']; //untuk ambil data
            $nama = $_POST['nama']; //untuk ambil data
            $email = $_POST['email']; //untuk ambil data
            $jenis_kelamin = $_POST['jenis_kelamin']; //untuk ambil data
        ...
        <?php } ?> <!--penutup kurung kurawal diatas-->
      </table>
    </div>
